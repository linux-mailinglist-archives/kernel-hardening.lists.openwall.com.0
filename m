Return-Path: <kernel-hardening-return-18418-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 8A35919DDCC
	for <lists+kernel-hardening@lfdr.de>; Fri,  3 Apr 2020 20:19:13 +0200 (CEST)
Received: (qmail 32132 invoked by uid 550); 3 Apr 2020 18:18:06 -0000
...
Received: (qmail 32041 invoked from network); 3 Apr 2020 18:18:04 -0000
...
Subject: [PATCH v11 4/8] proc: instantiate only pids that we can ptrace on 'hidepid=4' mount option
Date: Fri,  3 Apr 2020 20:06:44 +0200
Message-Id: <20200403180648.721362-5-gladkov.alexey@gmail.com>
...
X-Greylist: Sender succeeded SMTP AUTH, not delayed by milter-greylist-4.6.1 (raptor.unsafe.ru [5.9.43.93]); Fri, 03 Apr 2020 18:07:27 +0000 (UTC)
