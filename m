Return-Path: <kernel-hardening-return-16882-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 5C722AD5C7
	for <lists+kernel-hardening@lfdr.de>; Mon,  9 Sep 2019 11:34:00 +0200 (CEST)
Received: (qmail 13830 invoked by uid 550); 9 Sep 2019 09:33:54 -0000
...
Received: (qmail 13812 invoked from network); 9 Sep 2019 09:33:54 -0000
...
Subject: Re: [PATCH v2 1/5] fs: Add support for an O_MAYEXEC flag on
 sys_open()
To: Andy Lutomirski <luto@amacapital.net>, Jeff Layton <jlayton@kernel.org>
