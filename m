Return-Path: <kernel-hardening-return-19599-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id AAFD2242018
	for <lists+kernel-hardening@lfdr.de>; Tue, 11 Aug 2020 21:03:54 +0200 (CEST)
Received: (qmail 25880 invoked by uid 550); 11 Aug 2020 19:03:48 -0000
...
Received: (qmail 25811 invoked from network); 11 Aug 2020 19:03:36 -0000
...
> Link: https://lore.kernel.org/r/20200605160013.3954297-2-keescook@chromiu=
m.org
> ---
>  fs/exec.c | 3 +--
...
> --- a/fs/exec.c
> +++ b/fs/exec.c
> @@ -141,11 +141,10 @@ SYSCALL_DEFINE1(uselib, const char __user *, librar=
y)
>  	if (IS_ERR(file))
>  		goto out;
>=20=20
