Return-Path: <kernel-hardening-return-16026-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 28729316BD
	for <lists+kernel-hardening@lfdr.de>; Fri, 31 May 2019 23:47:51 +0200 (CEST)
Received: (qmail 7747 invoked by uid 550); 31 May 2019 21:47:44 -0000
...
Received: (qmail 7715 invoked from network); 31 May 2019 21:47:43 -0000
...
CC: Greg Kroah-Hartman <gregkh@linuxfoundation.org>, LKML
	<linux-kernel@vger.kernel.org>, "stable@vger.kernel.org"
	<stable@vger.kernel.org>, Thomas Gleixner <tglx@linutronix.de>, Andy
 Lutomirski <luto@amacapital.net>, Rick Edgecombe
	<rick.p.edgecombe@intel.com>, "Peter Zijlstra (Intel)"
	<peterz@infradead.org>, Andrew Morton <akpm@linux-foundation.org>, Ard
 Biesheuvel <ard.biesheuvel@linaro.org>, "Dock, Deneen T"
	<deneen.t.dock@intel.com>, Kernel Hardening
	<kernel-hardening@lists.openwall.com>, Kristen Carlson Accardi
	<kristen@linux.intel.com>, Damian Tometzki <linux_dti@icloud.com>, Will
 Deacon <will.deacon@arm.com>, Andy Lutomirski <luto@kernel.org>, Borislav
 Petkov <bp@alien8.de>, Dave Hansen <dave.hansen@intel.com>, "H. Peter Anvin"
	<hpa@zytor.com>, Jessica Yu <jeyu@kernel.org>, Kees Cook
	<keescook@chromium.org>, Linus Torvalds <torvalds@linux-foundation.org>,
	Masami Hiramatsu <mhiramat@kernel.org>, Rik van Riel <riel@surriel.com>, Ingo
 Molnar <mingo@kernel.org>, Sasha Levin <sashal@kernel.org>
...
x-microsoft-antispam:
 BCL:0;PCL:0;RULEID:(2390118)(7020095)(4652040)(8989299)(4534185)(4627221)(201703031133081)(201702281549075)(8990200)(5600148)(711020)(4605104)(1401327)(2017052603328)(7193020);SRVR:BYAPR05MB3942;
x-ms-traffictypediagnostic: BYAPR05MB3942:
x-microsoft-antispam-prvs:
 <BYAPR05MB3942E21B8E001320E43D7825D0190@BYAPR05MB3942.namprd05.prod.outlook.com>
...
x-microsoft-antispam-message-info:
 
