Return-Path: <kernel-hardening-return-18771-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 7DA771D0150
	for <lists+kernel-hardening@lfdr.de>; Tue, 12 May 2020 23:53:06 +0200 (CEST)
Received: (qmail 1245 invoked by uid 550); 12 May 2020 21:53:01 -0000
...
Received: (qmail 28190 invoked from network); 12 May 2020 21:40:47 -0000
...
Subject: Re: [PATCH v5 1/6] fs: Add support for an O_MAYEXEC flag on
 openat2(2)
To: Kees Cook <keescook@chromium.org>, =?UTF-8?Q?Micka=c3=abl_Sala=c3=bcn?=
 <mic@digikod.net>
Cc: linux-kernel@vger.kernel.org, Aleksa Sarai <cyphar@cyphar.com>,
 Alexei Starovoitov <ast@kernel.org>, Al Viro <viro@zeniv.linux.org.uk>,
 Andy Lutomirski <luto@kernel.org>, Daniel Borkmann <daniel@iogearbox.net>,
