Return-Path: <kernel-hardening-return-20688-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id D58172FFE39
	for <lists+kernel-hardening@lfdr.de>; Fri, 22 Jan 2021 09:33:52 +0100 (CET)
Received: (qmail 22443 invoked by uid 550); 22 Jan 2021 08:33:45 -0000
...
Received: (qmail 22390 invoked from network); 22 Jan 2021 08:33:44 -0000
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=J8rC8rrBASJfDx11gXKwp/a0LouMg3IPHJEbz9tEkDg=;
        b=
X-Gm-Message-State: AOAM533RZSYjAkDUhkSEjAur+GjY3h8m8zZUT3P8UMTDkDTVbp9Ty6DL
	E/UEuqQkBqCcEgjZTVtmeRAdEBKLT7P0B/6yf7c=
...
Cc: James Morris <jmorris@namei.org>, Jann Horn <jannh@google.com>, 
	...
	Arnd Bergmann <arnd@arndb.de>, Casey Schaufler <casey@schaufler-ca.com>, Jeff Dike <jdike@addtoit.com>, 
	Jonathan Corbet <corbet@lwn.net>, Kees Cook <keescook@chromium.org>, 
	Richard Weinberger <richard@nod.at>, Shuah Khan <shuah@kernel.org>, 
	Vincent Dagonneau <vincent.dagonneau@ssi.gouv.fr>, 
	Kernel-hardening <kernel-hardening@lists.openwall.com>, Linux API <linux-api@vger.kernel.org>, 
	linux-arch <linux-arch@vger.kernel.org>, linux-doc@vger.kernel.org, 
	"linux-fsdevel@vger.kernel.org" <linux-fsdevel@vger.kernel.org>, lkml <linux-kernel@vger.kernel.org>, 
	linux-kselftest@vger.kernel.org, 
	linux-security-module <linux-security-module@vger.kernel.org>, 
	"maintainer:X86 ARCHITECTURE (32-BIT AND 64-BIT)" <x86@kernel.org>, =?UTF-8?B?TWlja2HDq2wgU2FsYcO8bg==?= <mic@linux.microsoft.com>
