Return-Path: <kernel-hardening-return-20692-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 142453003A2
	for <lists+kernel-hardening@lfdr.de>; Fri, 22 Jan 2021 14:01:35 +0100 (CET)
Received: (qmail 9375 invoked by uid 550); 22 Jan 2021 13:01:04 -0000
...
Received: (qmail 9300 invoked from network); 22 Jan 2021 13:01:03 -0000
...
Subject: [PATCH v4 2/7] Move RLIMIT_NPROC counter to ucounts
Date: Fri, 22 Jan 2021 14:00:11 +0100
Message-Id: <70edce4f7ef461579f2590ca55a9ce734f23bf7c.1611320161.git.gladkov.alexey@gmail.com>
...
index 4cf93f9f93a6..68a87d05d8d5 100644
...
@@ -106,6 +109,16 @@ struct ucounts *get_ucounts(struct ucounts *ucounts);
...
index 9473e71e784c..fdb40adc2ebd 100644
--- a/kernel/cred.c
+++ b/kernel/cred.c
...
index 8d3cf7369ee7..e03a217949f4 100644
--- a/kernel/ucount.c
+++ b/kernel/ucount.c
@@ -7,6 +7,7 @@
...
+	{ },
 ...
 #endif /* CONFIG_SYSCTL */
@@ -215,6 +217,19 @@ static inline bool atomic_long_inc_below(atomic_long_t *v, int u)
 	}
 }
...
+
 ...
 {
@@ -248,6 +263,51 @@ void dec_ucount(struct ucounts *ucounts, enum ucount_type type)
 	put_ucounts(ucounts);
 }
