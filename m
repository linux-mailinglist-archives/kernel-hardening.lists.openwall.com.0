Return-Path: <kernel-hardening-return-16847-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id A446EABE73
	for <lists+kernel-hardening@lfdr.de>; Fri,  6 Sep 2019 19:14:34 +0200 (CEST)
Received: (qmail 8178 invoked by uid 550); 6 Sep 2019 17:14:27 -0000
...
Received: (qmail 8160 invoked from network); 6 Sep 2019 17:14:26 -0000
...
Subject: Re: [PATCH v2 1/5] fs: Add support for an O_MAYEXEC flag on
 sys_open()
To: Jeff Layton <jlayton@kernel.org>, Florian Weimer <fweimer@redhat.com>,
