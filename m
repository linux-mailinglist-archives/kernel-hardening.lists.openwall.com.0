Return-Path: <kernel-hardening-return-21756-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from second.openwall.net (second.openwall.net [193.110.157.125])
	by mail.lfdr.de (Postfix) with SMTP id B7E8992A849
	for <lists+kernel-hardening@lfdr.de>; Mon,  8 Jul 2024 19:36:02 +0200 (CEST)
Received: (qmail 1231 invoked by uid 550); 8 Jul 2024 17:35:47 -0000
...
Received: (qmail 1197 invoked from network); 8 Jul 2024 17:35:46 -0000
...
X-Spam-Status: No, score=0.7 required=8.0 tests=ALL_TRUSTED,BAYES_50,
	...
	XMSubLong,XM_B_AI_SPAM_COMBINATION,XM_B_SpammyWords,XM_B_Unicode
