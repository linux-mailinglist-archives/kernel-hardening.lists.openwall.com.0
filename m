Return-Path: <kernel-hardening-return-20923-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 7A4E7337022
	for <lists+kernel-hardening@lfdr.de>; Thu, 11 Mar 2021 11:38:20 +0100 (CET)
Received: (qmail 25865 invoked by uid 550); 11 Mar 2021 10:38:13 -0000
...
Received: (qmail 25845 invoked from network); 11 Mar 2021 10:38:13 -0000
Subject: Re: [PATCH v2 1/1] fs: Allow no_new_privs tasks to call chroot(2)
To: Jann Horn <jannh@google.com>, "Eric W. Biederman" <ebiederm@xmission.com>
