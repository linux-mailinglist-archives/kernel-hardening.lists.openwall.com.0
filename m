Return-Path: <kernel-hardening-return-19272-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 6676F21A4AC
	for <lists+kernel-hardening@lfdr.de>; Thu,  9 Jul 2020 18:22:36 +0200 (CEST)
Received: (qmail 3150 invoked by uid 550); 9 Jul 2020 16:22:30 -0000
...
Received: (qmail 3127 invoked from network); 9 Jul 2020 16:22:29 -0000
IronPort-SDR: a5STspjKPBoggqyWmV4OS18SDFivstbt7+fz5KEmCgpyLlr74ooSzvnSBxolPCxOCFQeWLCiG9
 MNefpnf7SikQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9677"; a="136253496"
X-IronPort-AV: E=Sophos;i="5.75,331,1589266800"; 
   d="scan'208";a="136253496"
...
Cc: "Andersen, John" <john.s.andersen@intel.com>,
 ...
 Greg KH <gregkh@linuxfoundation.org>, "Paul E. McKenney"
 <paulmck@kernel.org>, Pawan Gupta <pawan.kumar.gupta@linux.intel.com>,
 Juergen Gross <jgross@suse.com>, Mike Kravetz <mike.kravetz@oracle.com>,
 ...
 eric.auger@redhat.com, aaronlewis@google.com, Peter Xu <peterx@redhat.com>,
