Return-Path: <kernel-hardening-return-16879-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 086DCAD55E
	for <lists+kernel-hardening@lfdr.de>; Mon,  9 Sep 2019 11:09:45 +0200 (CEST)
Received: (qmail 17918 invoked by uid 550); 9 Sep 2019 09:09:39 -0000
...
Received: (qmail 17868 invoked from network); 9 Sep 2019 09:09:38 -0000
...
To: Aleksa Sarai <cyphar@cyphar.com>, Andy Lutomirski <luto@amacapital.net>
CC: Steve Grubb <sgrubb@redhat.com>, Florian Weimer <fweimer@redhat.com>,
	=?UTF-8?Q?Micka=c3=abl_Sala=c3=bcn?= <mic@digikod.net>,
	<linux-kernel@vger.kernel.org>, Alexei Starovoitov <ast@kernel.org>, Al Viro
	<viro@zeniv.linux.org.uk>, Andy Lutomirski <luto@kernel.org>, Christian
 Heimes <christian@python.org>, Daniel Borkmann <daniel@iogearbox.net>, Eric
 Chiang <ericchiang@google.com>, James Morris <jmorris@namei.org>, Jan Kara
	...
	<mtk.manpages@gmail.com>, Mimi Zohar <zohar@linux.ibm.com>,
 ...
 Shell <scottsh@microsoft.com>, Sean Christopherson
	...
	<songliubraving@fb.com>, Steve Dower <steve.dower@python.org>, Thibaut S
 autereau <thibaut.sautereau@ssi.gouv.fr>, Vincent Strubel
