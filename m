Return-Path: <kernel-hardening-return-20706-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 5641730A987
	for <lists+kernel-hardening@lfdr.de>; Mon,  1 Feb 2021 15:21:47 +0100 (CET)
Received: (qmail 26302 invoked by uid 550); 1 Feb 2021 14:21:14 -0000
...
Received: (qmail 26198 invoked from network); 1 Feb 2021 14:21:12 -0000
...
Subject: [PATCH v5 3/7] Reimplement RLIMIT_NPROC on top of ucounts
Date: Mon,  1 Feb 2021 15:18:31 +0100
Message-Id: <6cfa4ce08a396d6e059522cf99b442a38e6a987f.1612188590.git.gladkov.alexey@gmail.com>
...
index 43f5847cc897..bca7ba20f552 100644
...
@@ -106,6 +109,16 @@ struct ucounts *alloc_ucounts(struct user_namespace *ns, kuid_t uid);
...
index 8194a59e283f..05b215c490b0 100644
--- a/kernel/cred.c
+++ b/kernel/cred.c
...
@@ -393,8 +393,8 @@ int copy_creds(struct task_struct *p, unsigned long clone_flags)
 	}
 #endif
...
+	inc_rlimit_ucounts(task_ucounts(p), UCOUNT_RLIMIT_NPROC, 1);
 	...
 	validate_creds(new);
 	return 0;
@@ -494,12 +494,12 @@ int commit_creds(struct cred *new)
 	 * in set_user().
 	 */
 	alter_cred_subscribers(new, 2);
...
+		dec_rlimit_ucounts(old->ucounts, UCOUNT_RLIMIT_NPROC, 1);
 	...
 	/* send notifications */
@@ -702,6 +702,7 @@ void __init cred_init(void)
...
index b0d36dea0a9c..d50a720adbf1 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
...
index 9644bced74b4..8f5bc29ac453 100644
--- a/kernel/ucount.c
+++ b/kernel/ucount.c
@@ -7,6 +7,7 @@
...
+	{ },
 ...
 #endif /* CONFIG_SYSCTL */
@@ -209,6 +211,19 @@ static inline bool atomic_long_inc_below(atomic_long_t *v, int u)
 	}
 }
...
+
 ...
 {
@@ -242,6 +257,51 @@ void dec_ucount(struct ucounts *ucounts, enum ucount_type type)
 	put_ucounts(ucounts);
 }
