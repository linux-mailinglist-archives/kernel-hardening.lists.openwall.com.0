Return-Path: <kernel-hardening-return-19603-lists+kernel-hardening=lfdr.de@lists.openwall.com>
X-Original-To: lists+kernel-hardening@lfdr.de
Delivered-To: lists+kernel-hardening@lfdr.de
Received: from mother.openwall.net (mother.openwall.net [195.42.179.200])
	by mail.lfdr.de (Postfix) with SMTP id 7F8302420A7
	for <lists+kernel-hardening@lfdr.de>; Tue, 11 Aug 2020 21:55:03 +0200 (CEST)
Received: (qmail 23736 invoked by uid 550); 11 Aug 2020 19:54:57 -0000
...
Received: (qmail 23707 invoked from network); 11 Aug 2020 19:54:56 -0000
...
> https://lore.kernel.org/lkml/1e2f6913-42f2-3578-28ed-567f6a4bdda1@digikod=
.net/
>
...
>   https://lore.kernel.org/lkml/20200430015429.wuob7m5ofdewubui@yavin.dot.=
cyphar.com/
>
> Changes since v2:
...
>   https://lore.kernel.org/lkml/20181213094658.GA996@lithium.mbobrowski.or=
g/
> ---
>  fs/fcntl.c                       | 2 +-
>  fs/namei.c                       | 4 ++--
...
> --- a/fs/namei.c
> +++ b/fs/namei.c
> @@ -428,7 +428,7 @@ static int sb_permission(struct super_block *sb, stru=
ct inode *inode, int mask)
>  /**
>   * inode_permission - Check for access rights to a given inode
>   * @inode: Inode to check permission on
> - * @mask: Right to check for (%MAY_READ, %MAY_WRITE, %MAY_EXEC)
> + * @mask: Right to check for (%MAY_READ, %MAY_WRITE, %MAY_EXEC, %MAY_OPE=
NEXEC)
>   *
...
out
> @@ -2849,7 +2849,7 @@ static int may_open(const struct path *path, int ac=
c_mode, int flag)
>  	case S_IFLNK:
>  		return -ELOOP;
>  	case S_IFDIR:
...
> --- a/fs/open.c
> +++ b/fs/open.c
> @@ -987,6 +987,8 @@ inline struct open_how build_open_how(int flags, umod=
e_t mode)
>  		.mode =3D mode & S_IALLUGO,
>  	};
>=20=20
> +	/* O_MAYEXEC is ignored by syscalls relying on build_open_how(). */
> +	how.flags &=3D ~O_MAYEXEC;
>  	/* O_PATH beats everything else. */
>  	if (how.flags & O_PATH)
>  		how.flags &=3D O_PATH_FLAGS;
> @@ -1054,6 +1056,10 @@ inline int build_open_flags(const struct open_how =
...
> @@ -101,6 +101,8 @@ typedef int (dio_iodone_t)(struct kiocb *iocb, loff_t=
 offset,
...
>=20=20
>  /*
>   * flags in file.f_mode.  Note that FMODE_READ and FMODE_WRITE must corr=
espond
...
>=20=20
> +/*
> + * Code execution from file is intended, checks such permission.  A simp=
le
